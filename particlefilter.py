...
class robot:
    ...
    def move(self, motion, tolerence = 0.001): # Do not change the name of this function
        ...
        if abs(turn) < tolerence:
            res.x = res.x + distance2*cos(self.orientation)
            res.y = res.y + distance2*cos(self.orientation)
